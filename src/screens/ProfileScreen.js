...
import { View, Text, TouchableOpacity, ScrollView, StyleSheet, StatusBar, Alert, Linking, Platform } from 'react-native';
...
export default function ProfileScreen({ navigation }) {
    ...
    const handleLogout = () => {
        if (Platform.OS === 'web') {
            if (window.confirm('Are you sure you want to sign out of CareConnect?')) {
                signOut();
            }
        } else {
